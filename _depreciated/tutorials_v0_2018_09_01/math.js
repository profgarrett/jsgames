...
const randName = DataFactory.randName;
const randOf = DataFactory.randOf;


/*
	Math1 introduces basic math symbols.
	
	Introduction and then a short quiz.
*/
const simple_arithmetic_overview = {
	gen: LinearGen,
	pages: [
		{	type: 'IfPageTextSchema',
			description: `This tutorial introduces some common math symbols (or operators).
					<br/><br/>
...
const math1 = {
	code: 'math1',
	title: 'Simple math operators',
	description: 'Create basic arithmetic formulas.',
...
const math2 = {
	...
	description: 'Create advanced arithmetic formulas',

	gen: {
		gen: LinearGen,
		pages: [
			advanced_arithmetic_overview,
			advanced_arithmetic_test,
			...finish_questions
		]
	}
};
...
const math3 = {
	code: 'math3',
	title: 'Problem solving with arithmetic',
	description: 'Solve complicated problems with arithmetic.',

	gen: {
		gen: LinearGen,
		pages: [
			arithmetic_problem_solving,
			...finish_questions
		]
	}
};
