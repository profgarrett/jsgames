...
import { IfPageLongTextAnswerSchema, IfPageNumberAnswerSchema } from '../../../shared/IfPageSchemas';
import type { IStringIndexJsonObject } from '../../components/Misc';

interface PropsType  {
	page: IfPageLongTextAnswerSchema | IfPageNumberAnswerSchema;
	editable: boolean;
	readonly: boolean;
...
const ID = 'LongTextAnswerFieldInput';

/**
	A page shows an input for a number answer.
*/
export default class LongTextAnswer extends React.Component<PropsType> {
