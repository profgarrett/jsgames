...
export class KCCharts extends React.Component<PropsType, StateType> {
    ...
    _render_kc_charts_percentcorrect( data: { Correct: number, Incorrect: number, 'Correct, but slow': number } ): ReactElement {
 ...
 //               enableRadialLabels={ false }
  ...
  animate={false}
   ...
   //             values='seconds'
    ...
    _render_kc_answer_expandable( answers: Array<IfPageAnswer>): ReactElement {
