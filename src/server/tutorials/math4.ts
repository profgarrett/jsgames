...
const { kc_exponent_growth } = require('./../kcs/kc_exponent_growth');
const { kc_orderofoperation_and_growth } = require('./../kcs/kc_orderofoperation_and_growth');
