...
// Need to keep around to be able to analyze older submissions.
...
const { kc_dates } = require('./../kcs/kc_dates');
//const { kc_text } = require('./../kcs/kc_text');
...
export { functions2, functions2review };
