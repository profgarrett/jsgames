...
module.exports.sql01 = [
	...
	'CREATE TABLE `iflevels` ( `_id` INT NOT NULL AUTO_INCREMENT,   `username` VARCHAR(100) NOT NULL,   `code` VARCHAR(45) NOT NULL,  `title` VARCHAR(255) NOT NULL,   `description` LONGTEXT NOT NULL,   `completed` TINYINT(1) NOT NULL,  `pages` LONGTEXT NOT NULL, `history` LONGTEXT NOT NULL, `created` DATETIME NOT NULL, `updated` DATETIME NOT NULL,`score` LONGTEXT NOT NULL, PRIMARY KEY (`_id`));',
